...
@Component({
  selector: 'app-user-moderator-registration',
  templateUrl: './user-moderate-registration.html',
  styleUrl: './user-moderate-registration.scss',
})
export class UserModeratorRegistrationComponent implements OnInit, OnDestroy {
  ...
  programList: any = [];
  public userRoles = ['Moderator'];
  public activeUser: any = 'Moderator';
  ...
  public registerForm = this._fb.group(
    {
      ...
      securityAnswer: ['', [Validators.required, noWhitespaceValidator()]],
      studentIdCard: [''],
      profilePhoto: [''],
